...
class GroqProvider(BaseLLMProvider):
    ...
    async def analyze_contract(self, text: str) -> dict:
        ...
        logger.info("Groq: contract analysis completed")
    ...
    async def answer_question(self, question: str, chunks: list, contract_name: str) -> dict:
        ...
        1. query_type: "risk" if the question involves termination, penalties, ownership, non-compete,
           auto-renewal, confidentiality, or anything that could harm the user. Otherwise "factual"
